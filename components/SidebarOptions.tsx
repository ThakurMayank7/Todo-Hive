...
function SidebarOptions() {
  ...
  return (
    <div className="flex flex-col gap-1">
      ...
      <button
        className="bg-white text-black p-2 border-2 border-black shadow-gray-500 shadow-md hover:cursor-pointer hover:bg-gray-100 hover:font-bold font-semibold"
